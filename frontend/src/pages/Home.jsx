              ...
              <div key={product.id} className="group relative bg-gradient-to-b from-slate-900/60 to-slate-950 border border-slate-800 rounded-2xl md:rounded-[2rem] overflow-hidden hover:border-sky-500/50 transition-all duration-300 flex flex-col shadow-lg hover:shadow-sky-500/10 h-full">
                ...
                <Link to={`/product/${product.id}`} className="h-40 md:h-48 lg:h-56 bg-slate-900 relative overflow-hidden block group">
                  ...
                  <div className="absolute bottom-3 right-3 md:bottom-4 md:right-4">
                    <span className={`px-2 md:px-3 py-0.5 md:py-1 rounded-lg text-xs md:text-xs font-bold uppercase tracking-wider ${
                      product.is_in_stock 
                  ...
                  {productImages.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-2 md:left-3 top-1/2 -translate-y-1/2 bg-slate-950/70 hover:bg-slate-950 text-white p-1.5 md:p-2 rounded-full transition-all opacity-0 group-hover:opacity-100 z-20 text-sm md:text-base"
                      >
                        ‹
                      </button>
                      ...
                      <button
                        ...
                        className="absolute right-2 md:right-3 top-1/2 -translate-y-1/2 bg-slate-950/70 hover:bg-slate-950 text-white p-1.5 md:p-2 rounded-full transition-all opacity-0 group-hover:opacity-100 z-20 text-sm md:text-base"
                      >
                        ›
                      </button>
                ...
                <div className="p-4 md:p-6 flex flex-col flex-1 relative z-10">
                  ...
                  <button 
                    ...
                    className={`w-full font-black py-2.5 md:py-3 rounded-lg md:rounded-xl transition-all uppercase italic text-xs md:text-sm tracking-tight active:scale-95 duration-200 shadow-lg ${
                      product.is_in_stock 
